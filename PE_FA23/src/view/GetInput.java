...
public class GetInput
{
    ...
    public static boolean getBool(String prompt) 
    {
        ...
        if (input.equalsIgnoreCase("true") || input.equalsIgnoreCase("yes") || Integer.parseInt(input) == 1)     // change the string comparator based on project
            result = true;
        else if (input.equalsIgnoreCase("false") || input.equalsIgnoreCase("no") || Integer.parseInt(input) == 0)   // change the string comparator based on project
            result = false;
        else 
        {
